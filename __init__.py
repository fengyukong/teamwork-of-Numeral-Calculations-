...
sentiment_short = Sentiment.loc['2010':'2099']
...
tsplot(sentiment_short, title='Consumer Sentiment', lags=34)
plt.show()
# 上面那个直方图还可以再润色亿下
...
model_results = sm.tsa.ARIMA(ts_train, order=(3, 1,4 )).fit()
# 如果上面的结果不一致
...
#6.模型预测 最后的最后！
predict_sunspots = model_results.predict('2090','2099', dynamic=True)
print(predict_sunspots)
fig,ax = plt.subplots(figsize=(12, 8))
ax = Sentiment.loc['2010-01-01':].plot(ax=ax)
